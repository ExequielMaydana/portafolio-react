...
import cv from "../../assets/cv-maydana-hernan-frontend-developer.pdf";
        ...
        >
          ...
          >
            <p>
              ...
              CSS, JavaScript, y React. Tambien tengo conocimientos intermedios
              en Node.js con Express y PostgreSQL. Tengo conocimientos basicos
              de Python.
            </p>
            <p>
              Soy responsable, se aprovechar muy bien el tiempo, con atencion al
              detalle, me gusta trabajar en equipo aunque tambien puedo llevar a
              cabo proyectos por mi cuenta.
            </p>

            <p>
              Empece con la programación en el año 2021, en el curso de
              Argentina Programa, un curso de programación web con Java y SQL,
              cuando termine dicho curso me puse a profundizar todo lo que había
              visto por mi cuenta como autodidacta, luego en abril del año 2022
              empece a cursar el bootcamp de Academlo, en el cual aprendí las
              tecnologías necesarias para ser todo un Desarrollador Web
              Full-Stack. A lo largo de mi formación como desarrollador he
              enfatizado la importancia del código escalable y bien documentado.
            </p>
          </div>
